      ...
      <section class="store-heading">
        <div class="container">
          <div class="row">
            ...
            @auth
            <form action="{{ route('detail-add-cart', $product->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
                <button
            ...
            @else
            <a
                href="{{ route('login') }}" class="btn btn-success px-4 text-white btn-block mb-3">
                  Sign in to add
            </a>
            @endauth
            </div>
